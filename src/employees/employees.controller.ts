...
export class EmployeesController {
  ...
  findAll(
    ...
    return this.employeesService.findAll(pagination, filters);
  }
  ...
  assignCompany(
    ...
    return this.employeesService.assignCompany(id, body.companyId);
  }
  @Patch(':id/role')
  @Roles(UserRole.HR_MANAGER)
  updateRole(
    ...
    return this.employeesService.updateRole(id, dto.role, currentUser.id);
  }
